...
export default class ITL extends Component {
  constructor(props) {
    super(props);
    this.state = {
        consigner:"",
        ...
        <ListItem key={i} bottomDivider>
          <ListItem.Content>
            <ListItem.Title style={styles.title}>
              {`${item.serial}. ${item.date} ,Invoise no. ${item.invoisenumber} ( ${item.model} ):Rs.${item.amount}/-`}
            </ListItem.Title>
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.textinput}>List  Of  Purchase</Text>
        </View>
